import { Button, Space, Toast, Popup, Radio, Empty, Card } from 'antd-mobile';
import React, { useState, useEffect, useCallback } from 'react';
import { AiOutlineBook, AiOutlineFilter } from 'react-icons/ai';
...
const ArticlesPage: React.FC = () => {
          ...
          <div className={styles.filterSection}>
            ...
            <Radio.Group
              ...
              onChange={(value) =>
                setFilters((prev) => ({
                  ...prev,
                  difficulty: (value as string) || undefined,
                }))
              }
            >
          ...
          <div className={styles.filterSection}>
            ...
            <Radio.Group
              ...
              onChange={(value) =>
                setFilters((prev) => ({
                  ...prev,
                  articleType: (value as string) || undefined,
                }))
              }
            >
              <Space direction="vertical">
          ...
          <div className={styles.filterSection}>
            ...
            <Radio.Group
              ...
              onChange={(value) =>
                setFilters((prev) => ({
                  ...prev,
                  length: (value as string) || undefined,
                }))
              }
            >
              <Space direction="vertical">
    ...
    if (articles.length === 0) {
      return (
        <div className={styles.emptyContainer}>
          <Empty description="暂无文章" image={<AiOutlineBook size={64} />} />
        </div>
      );
    }
  ...
  return (
    ...
    >
      <div className={styles.pageContent}>{renderArticleList()}</div>
