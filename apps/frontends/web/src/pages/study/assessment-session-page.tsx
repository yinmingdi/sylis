import { ConsentPurpose, type ExerciseView } from '@sylis/api-client/user';
...
export function AssessmentSessionPage() {
  ...
  const query = useQuery(assessmentQueries.session(userId, sessionId));
          ...
          <ExercisePlayer
            ...
            onSubmit={async (attemptId, response, idempotencyKey) => {
              ...
              await cache.invalidateQueries({
                queryKey: assessmentQueries.session(userId, sessionId).queryKey,
              });
