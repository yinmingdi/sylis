...
class ProfileFactIndex {
  ...
  acceptCollection(collectionPath: string, value: unknown): void {
    if (!isRecord(value)) return;
    switch (collectionPath) {
      case "/sources/records":
        this.#sourceRecordIds.add(stringValue(value, "id"));
        return;
      case "/provenance/bundles":
      ...
      case "/lexicon/senseExamples":
        ...
        return;
      case "/learning/pedagogicalMaterialRevisions":
        this.#materialRevisions.set(stringValue(value, "id"), {
          kind: stringValue(value, "materialKind"),
        });
        return;
      case "/learning/pedagogicalMaterialTargets":
        if (
      ...
      case "/learning/objectiveSubjects":
        ...
        return;
      case "/learning/exerciseRevisions":
        if (
        ...
        return;
      case "/lexicon/senseCollocations":
        addToSetMap(
