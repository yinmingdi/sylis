        ...
        <div className={styles.wordHeader}>
          ...
          <div className={styles.wordMeta}>
            <div className={styles.badges}>
              ...
              {showProficiency && word.accuracyRate !== undefined && word.reviewCount && word.reviewCount > 0 && (
                <Badge
                  content={`正确率 ${(word.accuracyRate * 100).toFixed(0)}%`}
                  style={{
                    backgroundColor: word.accuracyRate >= 0.8 ? '#06d6a0' : word.accuracyRate >= 0.6 ? '#ff9f1c' : '#f71735',
                    color: '#fff'
                  } as React.CSSProperties}
                />
              )}
