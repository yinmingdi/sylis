...
`@sylis/harness` is a private, portable toolkit for generating and validating repository-local Agent Harnesses. It is not a product runtime dependency, an MCP server, or an agent orchestrator.
