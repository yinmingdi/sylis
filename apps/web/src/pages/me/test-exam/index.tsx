import type { TestQuestionDto, TestAnswerDto } from '@sylis/shared/dto';
...
import { startVocabularyTest, completeVocabularyTest } from '../../../modules/vocabulary/api';
...
const VocabularyTestExam = () => {
  ...
  const [currentPhase, setCurrentPhase] = useState<'loading' | 'testing' | 'result'>('loading');
  ...
  return (
    <PageView
      ...
      appBar={
        <AppBar title={getHeaderTitle()} onBack={handleBack} />
      }
    >
      {renderProgress()}
