...
export type ExerciseRevision = {
  ...
  gradingMode: "EXACT" | "WEIGHTED" | "SELF_REPORT" | "AI_ASSISTED";
  validationLevel:
    | "PRACTICE_ONLY"
    | "FORMATIVE_VERIFIED"
    | "SUMMATIVE_VERIFIED";
...
export interface LexiconGraph {
  ...
  senseRelations: Relation[];
  conceptRelations: Relation[];
...
export interface AssessmentBlueprint {
  id: Id;
  blueprintKey: Code;
  purpose: "PRACTICE" | "BOOK_CHECKPOINT" | "DIAGNOSTIC" | "PLACEMENT";
}
/**
 * This interface was referenced by `SylisLexiconArtifactV1`'s JSON-Schema
