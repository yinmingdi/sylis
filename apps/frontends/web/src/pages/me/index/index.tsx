...
import type { LearningStatsResDto } from '@/legacy-dto';
...
const Me = () => {
  ...
  const [learningStats, setLearningStats] = useState<LearningStatsResDto>({
    checkInDays: 0,
    learningProgress: 0,
    newWordsLearned: 0,
    reviewWords: 0,
  ...
  const userInfo = {
    nickname: '科幻迷的小日子',
    avatar:
      'https://images.unsplash.com/photo-1494790108755-2616b612b776?w=150&h=150&fit=crop&crop=face&fm=jpg',
    level: '初级学习者',
    hasVip: true,
  };
          ...
          <div className={styles.progressHeader}>
            <div className={styles.progressInfo}>
              <span className={styles.progressValue}>
                {loading
                  ? '加载中...'
                  : `${todayProgress.completed}/${todayProgress.total} 词`}
              </span>
            </div>
  ...
  return (
    <PageView className={styles.mePage}>
