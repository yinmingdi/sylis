...
const meta: Meta<typeof Form> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          '表单组件，提供完整的表单管理功能，包括数据收集、验证、提交等。专为英语学习应用设计。',
      },
    },
  },
  tags: ['autodocs'],
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
      ...
      <div>
        ...
        <Form style={{ width: '360px' }}>
          <FormItem label="邮箱地址" required helperText="将作为您的登录账号">
            <Input
              type="email"
              prefix={<AiOutlineMail />}
      ...
      <div>
        ...
        <Form layout="horizontal" labelWidth={120} style={{ width: '480px' }}>
          <FormItem label="每日目标" helperText="建议从较小目标开始">
          ...
          <FormItem label="学习科目" extra="可以随时调整学习重点">
            <Input
