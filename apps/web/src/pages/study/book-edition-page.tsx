...
export function BookEditionPage() {
  ...
  const enrollments = useQuery(booksQueries.enrollments);
  ...
  const enroll = useMutation({
    ...
    onSuccess: () =>
      cache.invalidateQueries({ queryKey: booksQueries.enrollments.queryKey }),
  });
    ...
    onSuccess: (_value, confirm) => {
      if (confirm) {
        void cache.invalidateQueries({
          queryKey: booksQueries.enrollments.queryKey,
        });
      }
    },
  });
