...
![Node.js](https://img.shields.io/badge/node-24-brightgreen?style=flat-square&logo=node.js)
...
**Sylis** is an **AI-powered English learning platform** built on modern web technologies.
...
- **AI Services**: OpenAI-compatible API accessed by the backend only
