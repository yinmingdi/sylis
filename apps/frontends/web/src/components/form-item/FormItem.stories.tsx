...
const meta: Meta<typeof FormItem> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          '表单项组件，为表单控件提供标签、错误信息、帮助文本等统一的布局和样式。',
      },
    },
  },
  tags: ['autodocs'],
...
export const ValidationStates: Story = {
  render: () => (
    ...
    >
      ...
      <FormItem label="错误状态" status="error" error="请输入有效的邮箱地址">
      ...
      <FormItem label="成功状态" status="success" helperText="验证通过">
    ...
    >
      <div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <FormItem label="邮箱地址" required helperText="作为登录账号使用">
            <Input
              type="email"
          ...
          <FormItem label="用户昵称" required extra="昵称将在学习社区中显示">
            <Input
              prefix={<AiOutlineUser />}
              placeholder="请输入昵称"
              showCount
      ...
      <div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          >
            <Input type="number" placeholder="30" suffix="分钟" />
          </FormItem>
